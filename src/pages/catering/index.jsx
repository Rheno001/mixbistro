            ...
            <section>
                ...
                <div className='carousel'>
                    <motion.div ref={ref11}
                        ...
                        <div
                            className="w-[99vw] bg-primary h-[40%] absolute z-[400] -top-[19%] clip-path-ellipse"
                        >
                        </div>
                        <div
                ...
                <div className='lg:py-[50px] px-[20px] lg:px-[150px]'>
                    <motion.div
                        ref={ref6}
                        initial={{ opacity: 0, y: -100 }}
                        animate={{
                    ...
                    <div className='flex items-center justify-center px-[20px] lg:px-[80px] py-[50px] sm:w-[75%] lg:w-[100%] relative z-[500]'>
                        <span className='text-center lg:mx-[20px]'>
