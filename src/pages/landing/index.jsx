    ...
    return (<div className='bg-primary overflow-hidden relative'>
                    ...
                    <Swiper
                        ...
                        pagination={{
                            ...
                            renderBullet: (index, className) => {
                                ...
                                return `<span class="${className} relative z-[100000000] custom-bullet"></span>`;
                            },
        ...
        <div className='flex justify-between flex-col-reverse lg:flex-row items-center py-[20px] lg:py-[70px] px-[5%] bg-accent'>
            ...
            <div className='flex justify-center items-center text-accent my-[10px] lg:hidden'>
                <Link to={'/catering#order-form'}><button className='relative z-[100000000] hero bg-primary rounded-[5px] px-[14px] lg:px-[62px] py-[7px] lg:py-[22px] text-[16px] lg:text-[25px] font-[600]'>Order Now</button></Link>
            </div>
        ...
        <div className='pt-[20px] bg-[#B56B47] noise lg:bg-primary lg:pt-[70px] px-[5%]'>
            ...
            <motion.div className='flex justify-center flex-col items-center mt-[20px] lg:mt-[80px] p-[10px] lg:pb-[70px] relative'>
                ...
                <div className='flex justify-center items-center text-primary lg:mt-[50px] lg:mb-[30px] mt-[20px] mb-[20px]'>
                    <Link to={'/catering'}><button className='relative z-[10000000] hero bg-accent rounded-[5px] px-[14px] lg:px-[62px] py-[5px] lg:py-[22px] text-[16px] lg:text-[25px] font-[600]'>View More</button></Link>
                </div>
            </motion.div>
        </div>
            ...
            <div className='flex flex-col lg:flex-row justify-between items-center lg:gap-[50px] pt-[20px] lg:pt-[80px]'>
                ...
                <motion.div ref={ref19}
                    ...
                    <div className='flex justify-center w-full items-center text-primary lg:mt-[50px] mt-[10px] lg:mb-[30px]'>
                        <Link to={'/catering'}><button className='relative z-[10000000] hero bg-accent rounded-[5px] px-[15px] lg:px-[62px] lg:py-[20px] py-[5px] lg:text-[25px] font-[600]'>View More</button></Link>
                    </div>
                </motion.div>
            </div>
        </div>
