...
const Card = ({img, heading, para}) => {
    return ( <>
    <div className='flex flex-col justify-center items-center w-[260px] lg:w-[412px]'>
        <img src={img} alt="" className='w-full object-cover relative z-[20] rounded-b-none' />
        <div className='bg-accent w-[412px] min-h-[100px] lg:min-h-[150px] rounded-b-[20px] px-[20px] pb-[20px]'>
